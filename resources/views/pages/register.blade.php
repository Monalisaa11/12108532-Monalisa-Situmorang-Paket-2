                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form action="{{route('register.store')}}" method="POST">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" id="exampleInputNamaLengkap" name="nama_lengkap" placeholder="NamaLengkap">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" id="exampleInputAlamat" name="alamat" placeholder="Alamat">
                                        </div>
